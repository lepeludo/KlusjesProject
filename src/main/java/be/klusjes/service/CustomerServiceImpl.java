...
public class CustomerServiceImpl implements CustomerService {
	...
	public void create(CustomerForm customerForm) throws MessagingException {
	...
	public void update(UpdateCustomerForm updateCustomerForm, Customer customer) {
		...
		customer.setUser(user);
		user.setEmail(updateCustomerForm.getEmail());
		user.setCustomer(customer);
		customerDao.update(customer);
	...
	@Override
	public List<Customer> findCustomersByTextPaged(String keyword, int fromRow,
			int numberOfRows) {
		return customerDao.findCustomersByTextPaged(keyword, fromRow, numberOfRows);
	}
